...
void Parallel1DFastFT::compute() {
     ...
     */
    printf("Running the Parallel 1D Fast Fourier Transform solver...\n");
...
#pragma omp parallel for
    ...
    printf("Parallel 1D Fast Fourier Transform computed. Elapsed time: %f ms.\n",
