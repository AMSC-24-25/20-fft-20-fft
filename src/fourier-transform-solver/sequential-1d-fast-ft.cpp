...
void Sequential1DFastFT::compute() {
    /**
     ...
     */
    printf("Running the Sequential Fast Fourier Transform solver...\n");
    ...
    printf("Sequential 1D Fast Fourier Transform computed. Elapsed time: %f ms.\n",
