#ifndef DISCRETE_COSINE_TRANSFORM_SOLVER_HPP
#define DISCRETE_COSINE_TRANSFORM_SOLVER_HPP
#include <vector>
#include <iostream>
#include <type_traits>
...
namespace dct::solver {
    ...
    public:
         ...
         * @param output The output vector after transformation.
         */
        void compute(std::vector<std::vector<double>> &input, std::vector<std::vector<double>> &output, const ComputationMode mode);
...
#endif //DISCRETE_COSINE_TRANSFORM_SOLVER_HPP
