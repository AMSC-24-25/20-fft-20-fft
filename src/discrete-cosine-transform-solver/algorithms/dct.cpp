#include "discrete-cosine-transform-solver/algorithms/dct.hpp"

namespace dct::algorithms {
    /* Function that computes the 1D Discrete Cosine Transform (DCT) of a vector.
     * Applies the DCT formula on the input vector, modifying it in-place.
     * @input: reference to the input vector to transform.
     */
